...
これは、学校のタブレットをぶっ壊す⭐︎ためのプロジェクトです、意外と真面目に作られている部分もあればスパゲッティーコードな部分も多いです。コメントアウトめっちゃあるから理解しやすいかもです。
## 主な機能
...
- proxy機能
- formsに似た何かを使って足りない部分などの送信
- 量産専用のgit
- musicのバックグラウンド再生(android専用)
- などなど
## ローカル開発環境
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/mumeidyo/suihanki-proxy)
