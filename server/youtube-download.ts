    ...
    try {
      ...
      const downloadWithYtDlp = async (): Promise<void> => {
        ...
        if (format === 'mp3') {
          ...
          // Video format with quality selection
          ...
          if (quality === 'highest' || quality === '1080p') {
            ...
            formatOption = 'bestvideo[height<=720][ext=mp4]+bestaudio[ext=m4a]/best[height<=720][ext=mp4]/best[height<=720]';
          } else if (quality === '480p') {
            formatOption = 'bestvideo[height<=480][ext=mp4]+bestaudio[ext=m4a]/best[height<=480][ext=mp4]/best[height<=480]';
      ...
      const downloadWithYtdlCore = async (): Promise<void> => {
        ...
        if (format === 'mp3') {
          ...
          let ytdlOptions: any = { quality: 'highest' };
          ...
          if (quality === 'highest' || quality === '1080p') {
            ...
            ytdlOptions = { 
              ...
              filter: (format: any) => format.height <= 720 
            };
          } else if (quality === '480p') {
            ytdlOptions = { 
              quality: 'highestvideo', 
              filter: (format: any) => format.height <= 480 
            };
          } else if (quality === 'lowest' || quality === '360p') {
